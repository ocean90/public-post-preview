...
},_pulsate:function(c,b){c.css("color",b).animate({opacity:1},600,"linear").animate({opacity:0},600,"linear",function(){c.text("");});}};a(function(){DSPublicPostPreview.initialize();
});})(jQuery);